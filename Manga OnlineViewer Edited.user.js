...
(function () {
  ...
  var tmofans2 = {
    name: 'TuMangaOnline',
    url: /https?:\/\/(www.)?(wtechnews|otakuworldgames|animationforyou|animalcanine|gamesnk|cook2love|mangalong|motornk|panicmanga|mistermanga|worldmangas|recipesnk|fanaticmanga|cookerready|anitoc|enginepassion|cooker2love|vsrecipes|recipesaniki|dariusmotor|vgmotor|mynewsrecipes|animation2you).com\/.+\/.+\/(paginated|cascade)/,
    homepage: 'https://lectortmo.com/',
    language: ['Spanish'],
    category: 'manga',
    run() {
