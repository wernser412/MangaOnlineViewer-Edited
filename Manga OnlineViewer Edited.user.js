...
// @include /https?:\/\/(www.)?(wtechnews|otakuworldgames|animationforyou|animalcanine|gamesnk|cook2love|mangalong|motornk|panicmanga|mistermanga).com\/.+\/.+\/(paginated|cascade)/
...
(function() {
  ...
  var tmofans2 = {
    name: 'TuMangaOnline',
    url: /https?:\/\/(www.)?(wtechnews|otakuworldgames|animationforyou|animalcanine|gamesnk|cook2love|mangalong|motornk|panicmanga|mistermanga).com\/.+\/.+\/(paginated|cascade)/,
    homepage: 'https://lectortmo.com/',
    language: ['Spanish'],
    category: 'manga',
    run() {
